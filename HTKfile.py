...
class HTKfile(object):
    ...
    def __init__(self, path):
        ...
        self.__feature_dim = int(self.__bytes_of_one_frame / 4 )                       # dimension of feature
    ...
    def read_data(self):
        curr_data = struct.unpack('>'+'f'*int(self.__frame_num)*int(self.__feature_dim), self.__input.read(int(self.__frame_num)*int(self.__bytes_of_one_frame)))
